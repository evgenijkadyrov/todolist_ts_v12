...
import {addTaskAC, changeTaskAC, removeTaskAC, tasksReducer} from '../features/TodolistsList/tasks-reducer';
...
function AppWithReducers() {
    ...
    let [tasks, dispatchToTasks] = useReducer(tasksReducer, {
        [todolistId1]: [
            {id: v1(), title: "HTML&CSS", status: TaskStatuses.Completed,description:'', completed:true, priority:TaskPriorities.Low,addedDate:'',deadline:'',order:2,startDate:'',todoListId: todolistId1},
        ...
        [todolistId2]: [
            ...
            {id: v1(), title: "React Book", status: TaskStatuses.Completed,description:'', completed:true, priority:TaskPriorities.Low,addedDate:'',deadline:'',order:2,startDate:'',todoListId: todolistId2}
        ]
    });
